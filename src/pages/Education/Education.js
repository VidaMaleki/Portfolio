  ...
  return (
    <div className="education">
      ...
      <div class="education-1">
        <h2 class="education-top-header">Education</h2>
        <div class="education-box">
          <div class="education-box-header"><h3>Ada Developer Academy ( Boot camp )</h3><h4>03/2022 - 01/2023</h4></div>
          <h4>Software Engineer</h4>
        </div>
        <div class="education-box">
          <div class="education-box-header"><h3>Islamic Azad University of Tabriz</h3><h4>09/2009 - 04/2014</h4></div>
