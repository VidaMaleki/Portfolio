    ...
    <div className="projects-container">
      ...
      <fast-card class="first-card" >
        ...
        <div class="ex-first-card" >
            ...
            <p>Technologies: FuLl-stack app,React, JavaScript, CSS, HTML, Python, Flask, PostgreSQL </p>
            <fast-button class="button-1" onclick="window.location.href='https://github.com/VidaMaleki/front-end-inspiration-board';">GitHub</fast-button>
        </div>
      </fast-card>
      <fast-card class="first-card" >
        ...
        <div class="ex-first-card" >
            <h2>Chat Log</h2>
            <p>Technologies: FuLl-stack app,React, JavaScript, CSS, HTML, Python, Flask, PostgreSQLL</p>
            <fast-button class="button-1" onclick="window.location.href='https://github.com/VidaMaleki/react-chatlog';">GitHub</fast-button>
        </div>
      </fast-card>
      <fast-card class="first-card" >
        ...
        <div class="ex-first-card" >
            ...
            <p>Technologies: React, JavaScript, CSS, HTML and Location and Temp API</p><br></br>
            <fast-button class="button-1" onclick="window.location.href='https://github.com/VidaMaleki/weather-report';">GitHub</fast-button>
        </div>
      </fast-card>
      <fast-card class="first-card" >
        ...
        <div class="ex-first-card" >
            <h2>Task List</h2>
            <p>Technologies: FuLl-stack app,React, JavaScript, CSS, HTML, Python, Flask, PostgreSQL</p>
            <fast-button class="button-1" onclick="window.location.href='https://github.com/VidaMaleki/task-list-front-end';">GitHub</fast-button>
        </div>
      </fast-card>
      <fast-card class="first-card" >
        <img class="first-card-img" alt="" src="https://img.etimg.com/thumb/msid-88634316,width-1200,height-900,imgsize-65126,resizemode-8,quality-100/tech/technology/tracking-the-buzz-in-tech.jpg" />
        <div class="ex-first-card" >
            ...
            <p>Technologies: FuLl-stack app,React, JavaScript, CSS, HTML, Python, Flask, PostgreSQL</p>
            <fast-button class="button-1" onclick="window.location.href='https://github.com/VidaMaleki/solar-system-api';">GitHub</fast-button>
        </div>
      </fast-card>
      <fast-card class="first-card" >
        <img class="first-card-img" alt="" src="https://img.etimg.com/thumb/msid-88634316,width-1200,height-900,imgsize-65126,resizemode-8,quality-100/tech/technology/tracking-the-buzz-in-tech.jpg" />
        <div class="ex-first-card" >
            <h2>Js-Adagrams</h2>
            <p>Technologies: React, JavaScript, Fast web compenents, CSS, and HTML</p><br></br>
            <fast-button class="button-1" onclick="window.location.href='https://github.com/VidaMaleki/js-adagrams';">GitHub</fast-button>
        </div>
      </fast-card>
      </div>
    </div>
